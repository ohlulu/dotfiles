...
# Enable `Tap to click`
# defaults write com.apple.AppleMultitouchTrackpad.plist Clicking -bool true # Covered by other settings
# defaults write com.apple.driver.AppleBluetoothMultitouch.trackpad Clicking -bool true # Redundant
# defaults write NSGlobalDomain com.apple.mouse.tapBehavior -int 1 # Redundant
# defaults -currentHost write NSGlobalDomain com.apple.mouse.tapBehavior -int 1 # Redundant
...
# defaults write com.apple.dock showLaunchpadGestureEnabled -bool false # User preference, can be uncommented if needed
...
# defaults write com.apple.dock persistent-apps -array # User preference, can be uncommented
